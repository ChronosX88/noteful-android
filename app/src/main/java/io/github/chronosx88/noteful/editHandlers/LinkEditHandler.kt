package io.github.chronosx88.noteful.editHandlers
...
class LinkEditHandler(private val onClick: (widget: View, link: String)->Unit) :
    ...
    internal class EditLinkSpan(private val onClick: (widget: View, link: String)->Unit) :
        ClickableSpan() {
